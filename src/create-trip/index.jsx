...
function CreateTrip() {
  ...
  return (
    <div className='sm:px-10 md:px-32 lg:px-56 xl:px-72 px-5 mt-10 w-screen'>
      ...
      <p className='mt-3 text-gray-500 text-xl'>Just provide some basic information, and our travel planner will generate a customized itinerary based on your preferences.</p>
